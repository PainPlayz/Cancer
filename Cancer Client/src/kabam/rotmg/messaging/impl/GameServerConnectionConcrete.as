...
import kabam.rotmg.messaging.impl.incoming.LootOpen;
...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function mapMessages():void {
        ...
        _local_1.map(LOOTOPEN).toMessage(LootOpen).toMethod(this.onLootboxOpened);

    }
    private function onLootboxOpened(_arg1:LootOpen):void {
        this.gs_.hudView.Secretmenu(_arg1.itemId_);
    }
