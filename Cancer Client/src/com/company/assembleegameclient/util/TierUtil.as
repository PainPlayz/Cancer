...
public class TierUtil {
    ...
    public static const LR_COLOR:uint = 0xFFD700;
    public static const Easter_COLOR:uint = 0x000000;
    ...
    public static function getTierTag(_arg1:XML, _arg2:int=12):UILabel{
        ...
        var _local10:Boolean = (_arg1.hasOwnProperty("RT"));
        var _local10:Boolean = (_arg1.hasOwnProperty("Easter"));
        var _local10:Boolean = (_arg1.hasOwnProperty("LR"));
