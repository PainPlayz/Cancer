...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ EntAncient = () => Behav()
            .Init("Ent Ancient",
                new State(
                    new TransformOnDeath("Purple Bag loot balloon", probability: 0.3),
                    new State("Idle",
            ...
            .Init("Actual Ent Ancient",
                new State(
                    new DropPortalOnDeath("Balloon Cave", 10),
                    new Prioritize(
                ...
                new ItemLoot("Honey Wood Bow", 0.008),
                new ItemLoot("GreenLight Gas Ring", 0.01),
