        ...
        private _ Oryx = () => Behav()
            .Init("Oryx the Mad God 2",
                new State(
                    ...
                    new State("Wait",
                       new PlayerWithinTransition(8, "Questions?"),
                       new ConditionalEffect(ConditionEffectIndex.Invulnerable)
                        ),
                    new State("Questions?",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new Taunt("Nooo! this cannot be!"),
                        new ChatTransition("Talk1", "??? wants his soul back"),
                        new TimedTransition(1500, "Questions???")
                        ),
                        new State("Questions???",
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
                            new ChatTransition("Talk1", "??? wants his soul back"),
                        new Taunt("You will die here in my cellar!"),
                        new TimedTransition(1500, "Questions????")
                        ),
                        new State("Questions????",
                            new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new Taunt("You'll die just like the others!"),
                        new ChatTransition("Talk1", "??? wants his soul back"),
                    new TimedTransition(3000, "Attack")
                        ),
                    new State("Talk1",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new Taunt("Wait, are you talking about ???"),
                        new TimedTransition(2000, "Talk2")
                        ),
                    new State("Talk2",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new Taunt("tell him 'He should've asked a long time ago. I've given it back'"),
                        new TimedTransition(2000, "Attack1")
                        ),
                    new State("Attack1",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new Taunt("but you must die now!"),
            ...
            .Init("Oryx the Mad God 1",
                new State(
                    ...
                    new State("Slow",
                        ...
                        new TimedTransition(5000, "Dance 1")
                        ),
                    new State("Dance 1",
                        new Flash(0xf389E13, 0.5, 60),
                        new Taunt("You're over"),
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
