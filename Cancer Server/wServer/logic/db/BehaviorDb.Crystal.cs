...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Crystal = () => Behav()
            ...
            .Init("Crystal Prisoner",
                new State(
                    ...
                    new State("start_the_fun",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Taunt("Hahahaha! Your death is near!"),
                ...
                new Threshold(0.0003,
                    new ItemLoot("Crystal Wand", 0.013),
                    new ItemLoot("Crystal Sword", 0.012),
                    new ItemLoot("Ultra Crystal Wand", 0.008),
                    new ItemLoot("Ultra Crystal Sword", 0.008)
                    )
            )
         ...
         .Init("Mythical Crystal",
            new State(
             new DropPortalOnDeath("Crystal Caverns Portal", 100),
            new State("1",
                new Taunt(0.8, "*Shakes*"),
                new HpLessTransition(0.6, "alt1")),
            new State("alt1",
                new SetAltTexture(1),
                new Taunt(0.4, "*Shakes some more*"),
                new HpLessTransition(0.3, "alt2")),
            new State("alt2",
                new SetAltTexture(2),
                new HpLessTransition(0.1, "done")),
            new State("done",
                new Taunt(0.4, "*Breaks!*"),
                new Flash(0xADD8E6, 0.2, 15),
                new TimedTransition(1200, "suicide")),
            new State("suicide",
                new Suicide()
