    ...
    partial class BehaviorDb
    {
        _ OceanTrench = () => Behav()
            ...
            .Init("Thessal the Mermaid Goddess Wounded",
                new State(
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Taunt("Whats the owners name?"),
                    new TimedTransition(12000, "Fail"),
                    new State("Texture1",
                        new ChatTransition("Prize", "Tidan"),
                        new ChatTransition("Fail", "Demon"),
                        new SetAltTexture(1),
                    ...
                    new State("Fail",
                        new Taunt("You speak LIES!!"),
                                                new Shoot(21, count: 2, shootAngle: 25, projectileIndex: 2, angleOffset: 0),
                        new Shoot(21, count: 2, shootAngle: 215, projectileIndex: 2, angleOffset: 90),
                        new Shoot(21, count: 2, shootAngle: 251, projectileIndex: 2, angleOffset: 180),
                        new Shoot(21, count: 2, shootAngle: 125, projectileIndex: 2, angleOffset: 270),
                                                new Shoot(21, count: 2, shootAngle: 25, projectileIndex: 2, angleOffset: 0),
                        new Shoot(21, count: 2, shootAngle: 200, projectileIndex: 2, angleOffset: 90),
                        new Shoot(21, count: 2, shootAngle: 225, projectileIndex: 2, angleOffset: 180),
                        new Shoot(21, count: 2, shootAngle: 252, projectileIndex: 2, angleOffset: 270),
                                                new Shoot(21, count: 2, shootAngle: 25, projectileIndex: 2, angleOffset: 0),
                        new Shoot(21, count: 2, shootAngle: 65, projectileIndex: 2, angleOffset: 90),
                        new Shoot(21, count: 2, shootAngle: 55, projectileIndex: 2, angleOffset: 180),
                        new Shoot(21, count: 2, shootAngle: 65, projectileIndex: 2, angleOffset: 270),
                                                new Shoot(21, count: 2, shootAngle: 25, projectileIndex: 2, angleOffset: 0),
                        new Shoot(21, count: 2, shootAngle: 45, projectileIndex: 2, angleOffset: 90),
                        new Shoot(21, count: 2, shootAngle: 135, projectileIndex: 2, angleOffset: 180),
                        new Shoot(21, count: 2, shootAngle: 85, projectileIndex: 2, angleOffset: 270),
                                                new Shoot(21, count: 2, shootAngle: 25, projectileIndex: 2, angleOffset: 0),
                        new Shoot(21, count: 2, shootAngle: 1, projectileIndex: 2, angleOffset: 90),
                        new Shoot(21, count: 2, shootAngle: 4, projectileIndex: 2, angleOffset: 180),
                        new Shoot(21, count: 2, shootAngle: 75, projectileIndex: 2, angleOffset: 270),
                                               new Shoot(21, count: 2, shootAngle: 25, projectileIndex: 2, angleOffset: 0),
                        new Shoot(21, count: 2, shootAngle: 215, projectileIndex: 2, angleOffset: 90),
                        new Shoot(21, count: 2, shootAngle: 251, projectileIndex: 2, angleOffset: 180),
                        new Shoot(21, count: 2, shootAngle: 125, projectileIndex: 2, angleOffset: 270),
            ...
            .Init("Grey Sea Slurp",
                new State(
                   ...
                   new Threshold(0.32,
                   new ItemLoot("Coral Blade", 0.007)
                 )
