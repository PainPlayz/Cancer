...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Mountain = () => Behav()
            .Init("White Demon",
                new State(
                    new DropPortalOnDeath("Darken Cave", 15),
                    new Prioritize(
                        new StayAbove(1, 200),
            ...
            .Init("Ent God",
                new State(
                    new DropPortalOnDeath("Balloon Portal", 15),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
            ...
            .Init("Lucky Ent God",
                ...
                new Threshold(0.18,
                    new ItemLoot("Potion of Defense", 0.05),
                    new ItemLoot("Lucky Leprechaun Robe", 0.02),
                    new EggLoot(EggRarity.Common, 0.1),
                    new EggLoot(EggRarity.Uncommon, 0.05)
                    )
            )
            .Init("Beholder",
                new State(
                    new DropPortalOnDeath("Puppet Theatre Portal", 15),
                    new Prioritize(
                        new StayAbove(1, 200),
                        new Follow(1, range: 7),
                        new Wander(0.4)
            ...
            .Init("Rock Bot",
                ...
                new ItemLoot("Reinforced Steel Bow", 0.004),
