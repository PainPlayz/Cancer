    ...
    partial class BehaviorDb
    {
        ...
        .Init("Ghost of Skuld",
            new State(
                ...
                new State("4",
                    new Taunt(true, "If you wish to battle then so be it!"),
                    new TimedTransition(0, "5")
                    ),
                //repeat
                new State("5",
                    new SetAltTexture(12),
                    new TimedTransition(200, "70")
                    ),
                new State("6",
                    new ChatTransition("7", "ready"),
                ...
                new State("70",
                    new Taunt(true, "This is your end! Prepare to die!"),
                    new TimedTransition(0, "71")
                    ),
                new State("71",
                    new SetAltTexture(12),
            ...
            new Threshold(0.001,
                ...
                new ItemLoot("Tablet of the Fallen Goddess", 0.008),
