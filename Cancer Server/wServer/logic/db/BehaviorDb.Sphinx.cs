            ...
            .Init("Grand Sphinx",
                    new State(
                        ...
                        new State("ArmorBreakAttack",
                            new Wander(0.0005),
                            new StayCloseToSpawn(0.5, 8),
                            new Shoot(0, projectileIndex: 1, count: 8, shootAngle: 5, coolDown: 300),
                        ...
                        new State("WeakenAttack",
                            new Wander(0.0005),
                            new StayCloseToSpawn(0.5, 8),
                            new Shoot(10, projectileIndex: 1, count: 3, shootAngle: 120, coolDown: 900),
                            new Shoot(10, projectileIndex: 1, count: 3, shootAngle: 15, fixedAngle: 40, coolDown: 1600, coolDownOffset: 0),
                            new Shoot(10, projectileIndex: 1, count: 3, shootAngle: 15, fixedAngle: 220, coolDown: 1600, coolDownOffset: 0),
                            new Shoot(10, projectileIndex: 1, count: 3, shootAngle: 15, fixedAngle: 130, coolDown: 1600, coolDownOffset: 800),
                            new Shoot(10, projectileIndex: 1, count: 3, shootAngle: 15, fixedAngle: 310, coolDown: 1600, coolDownOffset: 800),
                    ...
                    new Threshold(0.05,
                        ...
                        new ItemLoot("Ring of Souls", 0.009),

                        new ItemLoot("Axe of Skilled Warriors", 0.014)
                    ),
                    new Threshold(0.1,
                        new OnlyOne(
