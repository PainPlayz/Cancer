            ...
            .Init("Tomb Defender",
                new State(
                    ...
                    new Threshold(0.001,
                        ...
                        new ItemLoot("Ring of the Loyalty", 0.01),
                        new ItemLoot("Ultra Ring of the Loyalty", 0.007),

                        new ItemLoot("Tome of Holy Protection", 0.025),

                        new ItemLoot("Ultra Staff of Ra", 0.006),
                        new ItemLoot("Staff of Ra", 0.01),
                    ...
                    new Suicide()
                        ...
                        .Init("Tomb Support Statue",
                                new State(
                                    ...
                                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                        ...
                                        new TimedTransition(4000, "pause")
                                        ),
                                    new State("pause",
                                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                    new EntityNotExistsTransition("Tomb Defender", 4000, "Start")
                                        ),
                                        new State("Start",
                        ...
                        .Init("Tomb Attacker Statue",
                                new State(
                                    ...
                                    new State("pause",
                                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                    new EntityNotExistsTransition("Tomb Defender", 2000, "Start1")
                                        ),
                                    new State("Start1",
                                         new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                                        new EntityNotExistsTransition("Tomb Support", 2000, "Start")
                                    ),
                                        new State("Start",
                        ...
                        .Init("Tomb Support",
                                ...
                                new Threshold(0.001,
                                    new GoldLoot(100, 1000),
                                        ...
                                        new ItemLoot("Staff of Ra", 0.012),

                                        new ItemLoot("Ring of the Loyalty", 0.01),
                                        new ItemLoot("Ultra Ring of the Loyalty", 0.007),

                                        new ItemLoot("Ultra Ring of the Sphinx", 0.007),
                        ...
                        .Init("Tomb Attacker",
                                ...
                                new Threshold(0.001,
                                     new GoldLoot(100, 1000),
                                        ...
                                        new ItemLoot("Ultra Ring of the Nile", 0.007),
