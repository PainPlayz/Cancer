...
internal class TossEffCommand : Command
    ...
    {
        public SetTokensCommand() : base("tokens", 0) { }
        protected override bool Process(Player player, RealmTime time, string[] args)
        {
            if (string.IsNullOrEmpty(args[0]))
            {
    ...
    internal class SpawnCommand : Command
    {
        ...
        protected override bool Process(Player player, RealmTime time, string[] args)
        {
            ...
            {
                string name = string.Join(" ", args.Skip(0).ToArray());
                ushort objType;
    ...
    internal class SetpieceCommand : Command
    {
        ...
        protected override bool Process(Player player, RealmTime time, string[] args)
        {
            ...
            piece.RenderSetPiece(player.Owner, new IntPoint((int)player.X + 1, (int)player.Y + 0));
            return true;
        }
    }
