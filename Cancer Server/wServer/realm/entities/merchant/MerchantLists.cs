...
namespace wServer.realm.entities
{
    internal class MerchantLists
    {
        ...
        public static Dictionary<int, Tuple<int, CurrencyType>> prices = new Dictionary<int, Tuple<int, CurrencyType>>
        {
            ...
            //WEAPONS
            {0xaf6, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Wand Of Recompense T12
            ...
            {0xb02, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Bow Of Covert Havens T12
            ...
            {0xb08, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Staff of the Cosmic Whole T12
            ...
            {0xb0b, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Sword of Acclaim T12
            ...
            {0xaff, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Dagger Of Foul Malevolence T12
            ...
            //ARMORS
            {0xb05, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Robe of the Grand Sorcerer
            ...
            {0xafc, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Acropolis Armor T13
            ...
            {0xaf9, new Tuple<int, CurrencyType>(600, CurrencyType.Gold)}, //Hydra Skin Armor T13
            ...
            //PET FOOD
            {0xccc, new Tuple<int, CurrencyType>(950, CurrencyType.Gold)}, //Ambrosia 
            ...
            {0xc87, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare feline egg
            {0xc8a, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon canine egg
            {0xc8b, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare canine egg
            {0xc8e, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon avian egg
            {0xc8f, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare avian egg
            {0xc92, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon exotic egg
            {0xc93, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare exotic egg
            {0xc96, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon farm egg
            {0xc97, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare farm egg
            {0xc9a, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon woodland egg
            {0xc9b, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare woodland egg
            {0xc9e, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon reptile egg
            {0xc9f, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare reptile egg
            {0xca2, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon insect egg
            {0xca3, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare insect egg
            {0xca6, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon pinguin egg
            {0xca7, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare pinguin egg
            {0xcaa, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon aquatic egg
            {0xcab, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare aquatic egg
            {0xcae, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon spooky egg
            {0xcaf, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare spooky egg
            {0xcb2, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon humanoid egg
            {0xcb3, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare humanoid egg
            {0xcb6, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon ???? egg
            {0xcb7, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare ???? egg
            {0xcba, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon automaton egg
            {0xcbb, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare automaton egg
            {0xcbe, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //uncommon mystery egg
            {0xcbf, new Tuple<int, CurrencyType>(900, CurrencyType.Gold)}, //rare mystery egg
            {0xcc0, new Tuple<int, CurrencyType>(1600, CurrencyType.Gold)}, //Legendary mystery egg
            ...
            {0x701, new Tuple<int, CurrencyType>(175, CurrencyType.Gold)}, //Undead Lair Key
            {0x5019, new Tuple<int, CurrencyType>(750, CurrencyType.Gold)}, //Undead Lair Key
            {0x5043, new Tuple<int, CurrencyType>(1250, CurrencyType.Gold)}, //Undead Lair Key
            {0x705, new Tuple<int, CurrencyType>(50, CurrencyType.Gold)}, //Pirate Cave Key
            {0x70a, new Tuple<int, CurrencyType>(750, CurrencyType.Gold)}, //Abyss of Demons Key
            {0x70b, new Tuple<int, CurrencyType>(150, CurrencyType.Gold)}, //Snake Pit Key
            {0x710, new Tuple<int, CurrencyType>(800, CurrencyType.Gold)}, //Tomb of the Ancients Key
            {0x71f, new Tuple<int, CurrencyType>(175, CurrencyType.Gold)}, //Sprite World Key
            {0xc11, new Tuple<int, CurrencyType>(400, CurrencyType.Gold)}, //Ocean Trench Key
            ...
            {0xcdd, new Tuple<int, CurrencyType>(550, CurrencyType.Gold)},//Shatters Key
            {0x5084, new Tuple<int, CurrencyType>(750, CurrencyType.Gold)},//Dragons Lair Key
            {0x7010, new Tuple<int, CurrencyType>(750, CurrencyType.Gold)},//Crystal Caverns Key

            {0xb3e, new Tuple<int, CurrencyType>(10000, CurrencyType.Fame)}, //amulet of res
            {0x5053, new Tuple<int, CurrencyType>(6000, CurrencyType.Fame)}, //ultra amulet

            {0x5052, new Tuple<int, CurrencyType>(5000, CurrencyType.Gold)}, //ruby armor
            {0x5002, new Tuple<int, CurrencyType>(4200, CurrencyType.Gold)}, //reinforced bow
            {0x5083, new Tuple<int, CurrencyType>(3500, CurrencyType.Gold)}, //Golden Tome
            {0x5095, new Tuple<int, CurrencyType>(4500, CurrencyType.Gold)}, //coal sword
            {0x5000, new Tuple<int, CurrencyType>(4200, CurrencyType.Gold)}, //Tidan Robe 
            {0x5219, new Tuple<int, CurrencyType>(5500, CurrencyType.Gold)}, //emerald armor
            {0x7017, new Tuple<int, CurrencyType>(5000, CurrencyType.Gold)}, //diamond staff


            {0x5054, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //maxys
            {0x5055, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //
            {0x5056, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //
            {0x5057, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //
            {0x5058, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //
            {0x5059, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //
            {0x5060, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //
            {0x5061, new Tuple<int, CurrencyType>(3500, CurrencyType.Fame)}, //

            {0x5034, new Tuple<int, CurrencyType>(500, CurrencyType.Fame)}, //500 fame item
            {0x5035, new Tuple<int, CurrencyType>(100, CurrencyType.Fame)}, //100 fame item
            {0x5033, new Tuple<int, CurrencyType>(1000, CurrencyType.Fame)}, //1000 fame item

            {0x5032, new Tuple<int, CurrencyType>(1000, CurrencyType.Gold)}, //1000 gold item
            {0x5031, new Tuple<int, CurrencyType>(500, CurrencyType.Gold)}, //500 gold item
            {0x5030, new Tuple<int, CurrencyType>(100, CurrencyType.Gold)}, //100 gold item
          
        };
        public static int[] store9List = { //gold items
        ...
        public static int[] store19List = { //fame items
        ...
        public static int[] store20List = { //maxys
        ...
        public static int[] store10List = { //consumables
            0x5034,
            0x5035,
            0x5033,
        ...
        public static int[] store11List = { // consumables
            0x5032,
            0x5031,
            0x5030,
        ...
        public static int[] store14List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty
        public static int[] store15List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty
        public static int[] store16List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty
        public static int[] store17List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty
        public static int[] store18List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty
        public static int[] store13List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty
        public static int[] store12List = { 0xb41, 0xbab, 0xbad, 0xbac };//empty

        public static int[] store1List =
        {
            0x7010, 0x5084, 0x5019, 0x5043, 0xcdd, 0xcda, 0xccf, 0xcce, 0xc2f, 0xc23, 0xc19, 0xc11, 0x71f, 0x710,
